...
from modules.interunit import InterUnit
...
class Dualnet(nn.Module):
    def __init__(self, args,data):
        ...
        self.H_ner = BiLSTMCRF(args,input_size=args.char_hidden_dim+args.word_emb_dim,
                              tagset_size=data.hlabelset_size,name='High layer modules')
        self.B_ner = BiLSTMCRF(args, input_size=args.char_hidden_dim + args.word_emb_dim,
                              tagset_size=data.llabelset_size, name='bottom layer modules')
