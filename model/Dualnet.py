...
class DualNet(nn.Module):
    def __init__(self, args,data):
        ...
        self.H2BB = BiLSTMCRF(args,input_size=args.char_hidden_dim+args.word_emb_dim+data.hlabelset_size+data.llabelset_size+4,
                              tagset_size=data.hlabelset_size,name='H2BB')
        self.B2HH = BiLSTMCRF(args, input_size=args.char_hidden_dim+args.word_emb_dim+data.hlabelset_size+data.llabelset_size+4,
                              tagset_size=data.llabelset_size, name='B2HH')
